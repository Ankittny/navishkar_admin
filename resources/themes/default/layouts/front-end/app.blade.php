...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{asset('assets/back-end/company/').'/'.$web_config['fav_icon']['key']}}">
    <link rel="icon" type="image/png" sizes="32x32" href="{{asset('assets/back-end/company/').'/'.$web_config['fav_icon']['key']}}">
