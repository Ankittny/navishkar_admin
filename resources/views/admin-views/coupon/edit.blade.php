                    ...
                    <form action="{{route('admin.coupon.update',[$coupon['id']])}}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-lg-4 form-group free_delivery">
                                ...
                                <input type="number" min="0" max="1000000" step=".01" name="discount" class="form-control" id="discount" value="{{$coupon['discount_type']=='amount'? $coupon['discount']:$coupon['discount']}}"
                                    placeholder="{{translate('ex').':'.'500'}}" required>
                            </div>
                            <div class="col-md-6 col-lg-4 form-group">
                                <label for="name" class="title-color text-capitalize">{{translate('minimum_purchase')}}</label>
                                <input type="number" min="0" max="1000000" step=".01" name="min_purchase" class="form-control" id="minimum purchase" value="{{$coupon['min_purchase']}}"
                            ...
                            <div class="col-md-6 col-lg-4 form-group free_delivery" id="max-discount">
                                ...
                                <input type="number" min="0" max="1000000" step=".01" name="max_discount" class="form-control" id="maximum discount" value="{{$coupon['max_discount']}}"
