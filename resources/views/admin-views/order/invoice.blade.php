        ...
        @if ($order->order_type == 'default_type')
            <tr>
                ...
                <td class="text-right" style="padding:23px 16px">
                    ...
                    <div class="fz-17 text-primary text-right">{{ $orderTotalPriceSummary['totalAmount'] }}</div>
                </td>
            </tr>
            <tr>
                ...
                <table class="customers bs-0">
                    ...
                    @foreach($order->details as $key=>$details)
                        ...
                        <tr>
                            ...
                            <td class="text-right">
                                <div class="fz-10 text-dark">{{ $details['price'] }}</div>
                            </td>
                            <td class="text-right">
                        ...
                        <th class="calc-table">
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{ $orderTotalPriceSummary['itemPrice'] }}</td>
                                </tr>
                                <tr>
                                    <td class="text-left font-bold">{{ translate('product_Discount')}}</td>
                                    <td class="text-right">
                                        - {{ $orderTotalPriceSummary['itemDiscount'] }}</td>
                                </tr>
                                <tr>
                                    <td class="text-left font-bold">{{ translate('sub_Total')}}</td>
                                    <td class="text-right">{{ $orderTotalPriceSummary['subTotal'] }}</td>
                                </tr>
                                @if($order->order_type == 'default_type')
                                    <tr>
                                        <td class="text-left font-bold">{{ translate('shipping')}}</td>
                                        <td class="text-right">{{$orderTotalPriceSummary['shippingTotal'] }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    <td class="text-left font-bold">{{ translate('coupon_Discount')}}</td>
                                    <td class="text-right">
                                        - {{ $orderTotalPriceSummary['couponDiscount'] }}</td>
                                </tr>
                                <tr>
                                    <td class="text-left font-bold">{{ translate('tax')}}</td>
                                    <td class="text-right">{{ $orderTotalPriceSummary['taxTotal'] }}</td>
                                </tr>
                                @if ($order->order_type != 'default_type')
                                    <tr>
                                        <td class="text-left font-bold">{{ translate('extra_Discount')}}</td>
                                        <td class="text-right">
                                            - {{ $orderTotalPriceSummary['extraDiscount'] }}</td>
                                    </tr>
                                @endif
                                <tr>
                                    ...
                                    <td class="border-dashed-top font-weight-bold text-right fz-14">
                                        {{ $orderTotalPriceSummary['totalAmount'] }}
                                    </td>
                                </tr>
                                </tbody>
                            </table>
