                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="from_part_2">
                                        ...
                                        <input type="file" name="image-file" id="category-image" value="{{ $product->image }}" class="custom-file-input image-preview-before-upload" data-preview="#viewer" accept="image/*">
                                ...
                                <div class="col-lg-6 mt-4 mt-lg-0 from_part_2">
                                    <div class="form-group">
                                        <div class="text-center mx-auto">
                                            <img class="upload-img-view" id="viewer" alt="" src="{{ asset('public/assets/back-end/work-shop-product/' . $product->image) }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
